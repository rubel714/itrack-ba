...
import LeadStatusAddEditModal from "./LeadStatusAddEditModal";

const LeadStatus = (props) => {
  const serverpage = "leadstatus"; // this is .php server page
  ...
  return (
    <>
      <div class="bodyContainer">
        ...
        <div class="topHeader">
          <h4>
            <a href="javascript:void(0)" onClick={() => props.history.push("/home")}>Home</a> ❯ Basic Setup ❯ Lead Status
          </h4>
        </div>
      ...
      {showModal && (<LeadStatusAddEditModal masterProps={props} currentRow={currentRow} modalCallback={modalCallback} />)}
