...
import InvoiceTypeAddEditModal from "./InvoiceTypeAddEditModal";
  ...
  return (
    <>
      <div class="bodyContainer">
        ...
        <div class="topHeader">
          <h4>
            <a href="javascript:void(0)" onClick={() => props.history.push("/home")}>Home</a> ❯ Settings ❯ Invoice Status
          </h4>
        </div>
      ...
      {showModal && (<InvoiceTypeAddEditModal masterProps={props} currentRow={currentRow} modalCallback={modalCallback} />)}
