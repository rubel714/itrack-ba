...
const TatMissingReport = (props) => {
  ...
  const columnList = [
    ...
    {
      field: "AuditEndDate",
      title: "Audit End tDate",
      hozAlign: "left",
      width: "140",
      // headerFilter:"input"
    },
    {
      field: "ReportWritingDate",
      title: "Report Writing Date",
      hozAlign: "left",
      width: "150",
      // headerFilter:"input"
    },
  ...
  return (
    <>
      <div class="bodyContainer">
        ...
        <div class="searchAdd">
          <div>
            <label>Strategic TAT Start Date</label>
            <div class="">
              <input
                type="date"
                id="StartDate"
          ...
          <div>
            <label>Strategic TAT End Date</label>
            <div class="">
              <input
                type="date"
                id="EndDate"
