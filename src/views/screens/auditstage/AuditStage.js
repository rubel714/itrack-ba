...
import AuditStageAddEditModal from "./AuditStageAddEditModal";

const AuditStage = (props) => {
  const serverpage = "auditstage"; // this is .php server page
  ...
  return (
    <>
      <div class="bodyContainer">
        ...
        <div class="topHeader">
          <h4>
            <a href="javascript:void(0)" onClick={() => props.history.push("/home")}>Home</a> ❯ Basic Setup ❯ Audit Stage
          </h4>
        </div>
      ...
      {showModal && (<AuditStageAddEditModal masterProps={props} currentRow={currentRow} modalCallback={modalCallback} />)}
