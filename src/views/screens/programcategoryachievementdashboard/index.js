...
import ProgramCategoryAchievementDashboard from "./ProgramCategoryAchievementDashboard";

const Index = (props) => {
  const { path } = useRouteMatch();
  const menukey = "programcategoryachievementdashboard"; // this is in t_menu table
        ...
        <div class="mainContainer">
          ...
          <Switch>
            <Route
              path={`${path}/`}
              render={(props) => (
                <ProgramCategoryAchievementDashboard
                  {...props}
