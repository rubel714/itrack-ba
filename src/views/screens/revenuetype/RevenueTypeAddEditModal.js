...
const RevenueTypeAddEditModal = (props) => { 
  ...
  const validateForm = () => {
    ...
    let validateFields = ["RevenueTypeName","Rate"]
    let errorData = {}
    let isValid = true
        ...
        <div class="modal-content">
          ...
          <div class="modalItem">
            ...
            <input
              ...
              class={errorObject.RevenueTypeName}
              placeholder="Enter Revenue Type"
              value={currentRow.RevenueTypeName}
...
export default RevenueTypeAddEditModal;
