...
import FactoryGroupsAddEditModal from "./FactoryGroupsAddEditModal";

const FactoryGroups = (props) => {
  ...
  return (
    <>
      <div class="bodyContainer">
        ...
        <div class="topHeader">
          <h4>
            <a href="javascript:void(0)" onClick={() => props.history.push("/home")}>Home</a> ❯ Basic Setup ❯ Factory Groups
          </h4>
        </div>
      ...
      {showModal && (<FactoryGroupsAddEditModal masterProps={props} currentRow={currentRow} modalCallback={modalCallback} />)}
