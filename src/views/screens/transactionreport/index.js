...
import TransactionReport from "./TransactionReport.js";

const Index = (props) => {
  const { path } = useRouteMatch();
  const menukey = "transactionreport"; // this is in t_menu table
      ...
      <div class="pb-30">
        ...
        <Switch>
          <Route
            path={`${path}/`}
            render={(props) => (
              <TransactionReport {...props} openNoticeModal={openNoticeModal} 
