...
import ZoneAddEditModal from "./ZoneAddEditModal";

const Zone = (props) => {
  const serverpage = "zone"; // this is .php server page
  ...
  return (
    <>
      <div class="bodyContainer">
        ...
        <div class="topHeader">
          <h4>
            <a href="javascript:void(0)" onClick={() => props.history.push("/home")}>Home</a> ❯ Basic Setup ❯ Zone
          </h4>
        </div>
      ...
      {showModal && (<ZoneAddEditModal masterProps={props} currentRow={currentRow} modalCallback={modalCallback} />)}
