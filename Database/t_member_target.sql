...
CREATE TABLE `t_member_target` (
  ...
  `OnSiteTarget` decimal(15,2) DEFAULT NULL,
  `OffSiteTarget` decimal(15,2) DEFAULT NULL,
  `ReCertificationRevenueTarget` decimal(15,2) DEFAULT NULL,
  `NewCertificationRevenueTarget` decimal(15,2) DEFAULT NULL,
  `RevenueTarget` decimal(15,2) DEFAULT NULL,
